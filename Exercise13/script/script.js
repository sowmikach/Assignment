...
function displayBiryaniMenu(){
  ...
  //Todo: Innclude a let/const/var for all variables
  str="";
...
function displayPizzaMenu(){
  ...
  for(var i=0; i<pizza_items.length; i++){
    str+="<li id="+i+" onClick='this.addToCart_p(this.id)'>"+pizza_items[i]+"</li>";
  }
  document.getElementById("pizzaVarieties").innerHTML=str;
  document.getElementById("back_p").onclick= displayMainMenu;
}
  //Todo: Innclude all global variables at start of file
...
// TODO:Function logic is repeated. Make it reusable
